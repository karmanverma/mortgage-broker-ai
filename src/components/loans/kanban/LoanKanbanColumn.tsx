...
interface LoanKanbanColumnProps {
  column: Column;
  loans: Loan[];
  isOverlay?: boolean;
...
export function LoanKanbanColumn({ 
  column, 
  loans, 
  isOverlay,
  onLoanClick 
}: LoanKanbanColumnProps) {
...
export function LoanKanbanContainer({ children }: { children: React.ReactNode }) {
